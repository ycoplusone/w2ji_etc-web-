...
function again(){
	clearInterval(matchingGame.timer);
	$("#cards").empty();
	$("#cards").append("<div class='card'><div class='face front'></div><div class='face back'><div class='name'></div><div class='login'></div></div></div>");
...
function init(){
    ...
    getHubbers(function (hubbers) {
        for (var i = 0; i < hubbers.hubbers.length; ++i) {
			...
			temp_game.push(hubbers.hubbers[i], hubbers.hubbers[i]);
